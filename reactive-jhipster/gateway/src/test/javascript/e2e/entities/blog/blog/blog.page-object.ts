...
export default class BlogComponentsPage extends AlertPage {
...
export class BlogDeleteDialog {
  ...
  title: ElementFinder = element(by.id('gatewayApp.blogBlog.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-blog'));
}
