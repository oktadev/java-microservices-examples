...
```
$ docker image tag blog gcr.io/ionic-social-286904/blog
$ docker push gcr.io/ionic-social-286904/blog
$ docker image tag gateway gcr.io/ionic-social-286904/gateway
$ docker push gcr.io/ionic-social-286904/gateway
$ docker image tag store gcr.io/ionic-social-286904/store
$ docker push gcr.io/ionic-social-286904/store
```
